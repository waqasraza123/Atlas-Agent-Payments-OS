...
- Next active implementation track: live upstream identity ownership, real non-local restore execution ownership, secret-manager-backed execution ownership, and environment-specific deployment runner adoption
...
- The current active execution slice is live upstream identity ownership, real non-local restore execution ownership, secret-manager-backed execution ownership, and environment-specific deployment runner adoption
