...
- live deployment-runner ownership, non-local restore ownership, external alert dispatch, long-term metrics retention, live upstream identity-provider ownership, and secret-manager-backed rotation ownership are still pending
