...
- Read [docs/project-state.md](/Users/mc/development/blockchain/ethereum/Atlas-Agent-Payments-OS/docs/project-state.md) before making implementation decisions.
- Read [docs/_local/current-session.md](/Users/mc/development/blockchain/ethereum/Atlas-Agent-Payments-OS/docs/_local/current-session.md) if it exists before starting work.
