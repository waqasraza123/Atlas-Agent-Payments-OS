...
export {
  ...
  type AtlasObservabilityDeliveryKind,
  ...
  type AtlasObservabilityTelemetryOwnershipSampleRecord,
  type AtlasObservabilityTelemetryOwnershipTrendRecord,
  type AtlasObservabilityTelemetryOwnershipWindowRecord,
